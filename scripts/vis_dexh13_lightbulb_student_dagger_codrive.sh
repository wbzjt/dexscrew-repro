...
CKPT="outputs/Dexh13HoraLightbulb_student_dagger_codrive/${CACHE}/dagger_nn/model_best.ckpt"
...
train.ppo.output_name=Dexh13HoraLightbulb_student_dagger_codrive/${CACHE}_vis \
experiment=student_codrive_dagger_vis \
test=True \
task.env.numEnvs=1 \
