...
python train.py task=Dexh13HoraLightbulbMiddleScalePos headless=${HEADLESS} seed=${SEED} \
experiment=middle_scalepos \
train.algo=PPO \
wandb_activate=False \
train.ppo.output_name=Dexh13HoraLightbulb_teacher_middle_scalepos/${CACHE} \
