...
train.ppo.proprio_adapt=True train.ppo.output_name=XHandHoraScrewDriver_student_padapt_trainrange/${CACHE} \
+train.ppo.student_trainable_param_patterns=[adapt_tconv,actor_mlp,mu] \
