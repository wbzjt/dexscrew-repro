...
PY_ARGS=(
    ...
    train.ppo.output_name=Dexh13HoraLightbulb_teacher_sim2real_twofinger_codrive_thesis/${CACHE}
    "checkpoint=outputs/Dexh13HoraLightbulb_teacher_sim2real_twofinger_codrive_thesis/${CACHE}/stage1_nn/best_reward_*.pth"
)
