...
# Canonical 15-min acceptance run for latent diffusion student baseline.
# Usage:
#   scripts/screwdriver_student_diffusion_latent_15min_docker.sh GPU_ID SEED TEACHER_CACHE [WINDOW_SEC] [DIFF_CACHE]
...
OUT_DIR="outputs/XHandHoraScrewDriver_student_diffusion_latent/${DIFF_CACHE}"
...
PY
set +e
timeout ${WINDOW_SEC} scripts/screwdriver_student_diffusion_latent.sh ${GPU_ID} ${SEED} ${DIFF_CACHE} \
...
echo "Diffusion latent 15-min acceptance finished."
